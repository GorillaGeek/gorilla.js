...
var foolproof = {
	is: function (value1, operator, value2, passOnNull) {
		...
		var isDate = function (input) {
			...
			return moment(input, "DD/MM/YYYY").isValid() && input.length == 10;
		};
		...
		if (isDate(value1)) {
			value1 = moment(value1, "DD/MM/YYYY").toDate();
			value2 = moment(value2, "DD/MM/YYYY").toDate();
		} else if (isBool(value1)) {
			value1 = (value1 == "false" || value1 == "False") ? false : value1;
			value2 = (value2 == "false" || value2 == "False") ? false : value2;

			value1 = !!value1;
			value2 = !!value2;
		}
		else if ($.validator.methods.number(value1) && value1.length > 0) {
	...
	getId: function (element, dependentPropety) {
		var pos = element.id.lastIndexOf("_") + 1;
		return element.id.substr(0, pos) + dependentPropety.replace(/\./g, "_");
	},

	getName: function (element, dependentPropety) {
